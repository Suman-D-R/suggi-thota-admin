    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        if (productsData.length === 0 && (response.meta?.total || 0) > 0) {
          console.warn(
            'API returned products but data array is empty',
            response
          );
        }
      } else {
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align='end' className='w-[160px]'>
                        ...
                        >
                          <PackageOpen className='mr-2 h-3.5 w-3.5 text-slate-500' />{' '}
                          Manage Inventory
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
              ...
              <TableRow>
                <TableCell colSpan={3} className='h-24 text-center'>
                  <div className='flex flex-col items-center justify-center text-muted-foreground py-8'>
                    ...
                    <Button
                      variant='link'
                      className='text-emerald-600 h-auto p-0 mt-2 text-xs'
                      onClick={clearFilters}
                    >
                      Clear all filters
                    </Button>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              ". This action cannot be undone. All product images will also be
              deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
